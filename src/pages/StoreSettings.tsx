 ...
 * Esto permite que los cambios en configuración aparezcan instantáneamente en la tienda.
 */
...
const StoreSettings: React.FC = () => {
  ...
  const handleSaveGeneral = async () => {
    ...
    try {
      ...
      // ✨ Revalidar configuración general en el storefront (home + contact + about)
      revalidateStorefront(['store-config', 'store-general']);
    } finally {
  ...
  const handleSaveBranding = async () => {
    ...
    // ✨ Revalidar logo y favicon en el storefront
    revalidateStorefront(['store-logo', 'store-config']);
  };
  ...
  const handleSavePolicy = async () => {
    ...
    // ✨ Revalidar políticas en el storefront
    revalidateStorefront(['policies']);
  };
  ...
  const handleAddCarousel = async () => {
    ...
    // ✨ Revalidar carrusel en el storefront
    revalidateStorefront(['carousel']);
  };
