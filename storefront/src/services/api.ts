...
// Bases configurables
const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://api.gotasdefe.com/api'; // Backend NestJS
const PUBLIC_API_BASE_URL = process.env.NEXT_PUBLIC_PUBLIC_API_URL || 'https://api.gotasdefe.com/api'; // Backend NestJS
