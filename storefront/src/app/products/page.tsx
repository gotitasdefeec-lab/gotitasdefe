...
// Cache de 24 horas para ahorrar bandwidth. On-Demand Revalidation actualiza instantáneamente cuando cambias productos
...
async function getProducts(categoryName?: string | null) {
  try {
    ...
    const res = await fetch(url, { next: { revalidate: 86400, tags: ['products', 'categories'] } });
