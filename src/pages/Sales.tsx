 ...
 * Usado cuando las ventas modifican el stock de productos.
 */
...
const Sales = () => {
  ...
  const saveDetails = async () => {
    ...
    try {
      ...
      if (!selected.id) {
        ...
        // ✨ Revalidar productos en el storefront (el stock cambió)
        ...
        // ✨ Revalidar productos en el storefront (el stock pudo cambiar)
        revalidateStorefront(['products', 'featured-products']);
      }
    } catch (e: any) {
  ...
  const deleteOrder = async (order: any) => {
    ...
    try {
      ...
      // ✨ Revalidar productos en el storefront (el stock fue restaurado)
      revalidateStorefront(['products', 'featured-products']);
    } catch (e) { }
  };
